...
public class BluetoothLeService extends Service {
    ...
    public static final String deviceAddress = "98:7B:F3:1F:7E:44";
    public static final String deviceName = "HMSoft";
    ...
    public void writeCharacteristic(String command){
        ...
        if(characteristic==null){
            while(mBluetoothGatt.getService(MasterActivity.SERVICE_UUID)==null);
            BluetoothGattService service = mBluetoothGatt.getService(MasterActivity.SERVICE_UUID);
            characteristic = service.getCharacteristic(MasterActivity.HM10_CHARACTERISTIC);
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(MasterActivity.NOTIFICATION_CHARACTERISTIC);
